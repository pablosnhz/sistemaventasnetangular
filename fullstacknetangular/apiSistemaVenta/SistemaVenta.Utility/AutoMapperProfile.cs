...
namespace SistemaVenta.Utility
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Usuario, SesionDTO>().ForMember
                (destino => destino.RolDescripcion, opt => opt.MapFrom(origen =>
                    origen.IdRolNavigation.Nombre
                ));

            CreateMap<UsuarioDTO, Usuario>().ForMember
                (destino => destino.IdRolNavigation, opt => opt.Ignore())
                .ForMember(destino =>
                 destino.EsActivo,
            ...
            #region DatalleVenta
            CreateMap<DatalleVenta, DetalleVentaDTO>()
            ...
            CreateMap<DetalleVentaDTO, DatalleVenta>()
                .ForMember(destino => destino.Precio,
